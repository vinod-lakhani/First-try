  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (store.payrollContributions) {
        ...
        const grossIncome = store.income?.grossIncome$ || incomeAmount;
