...
const getStageFromPath = (pathname: string, isManualEntry: boolean): string => {
  ...
  // Savings (savings-plan replaced by savings-allocator during onboarding)
  if (
    pathname === '/onboarding/payroll-contributions' ||
    pathname === '/onboarding/savings-plan' ||
    pathname?.includes('/app/tools/savings-allocator')
  ) {
    return 'savings';
  }
