...
export function calculateDisplaySavingsBreakdown(
  ...
  // Defensive: whenever payroll data (payrollContributions) implies a higher non-cash total than plan/customAlloc, use it so plan-final and Income never diverge.
